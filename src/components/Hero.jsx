    ...
    <section className={`relative w-full flex-col flex  h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100  `}>
            {" "}
            <span className="text-[#915eff] text-3xl ">Founder </span> of{" "}
            ...
            <span class="text-gray-400 text-lg">
              <br /> Ultimate Academic, Career, and Personal Growth Platform for
              IIIT Pune Students.
            </span>{" "}
          </p>
        </div>
      ...
      >
        ...
        <div>
          ...
          <p className={` text-xl mt-2 text-gray-400  `}>CGPA : 8.87</p>
        </div>
      </div>
    </section>
  );
