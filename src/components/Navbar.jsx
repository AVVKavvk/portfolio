    ...
    >
      <div class="w-full flex justify-between items-center max-w-7xl mx-auto ">
        ...
        >
          ...
          <p Class="text-white text-[20px] font-bold cursor-pointer ">
            Vipin Kumawat
          </p>
        </a>
        ...
        <ul class="list-none hidden sm:flex flex-row gap-10 ">
          ...
          <li
            class={` text-secondary hover:text-white text-[20px] font-medium cursor-pointer transition-all duration-200 `}
          >
            <a href="https://vipinkumawat.xyz/blogs" target="_blank">
              Blogs
            </a>
          </li>
        </ul>
        ...
        <div class="sm:hidden flex flex-1 justify-end items-center ">
          ...
          <div
            class={`${!toggle ? "hidden" : "flex"} p-6 black-gradient absolute top-20 right-0 mx-4 my-3 min-w-[140px] z-10 rounded-xl `}
          >
